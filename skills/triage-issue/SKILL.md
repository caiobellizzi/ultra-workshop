...
#  Original Claude Code instruction: "Use the Agent tool with subagent_type=Explore to deeply investigate the codebase."]

Use search and read_file tools to deeply investigate the codebase. Your goal is to find:
...
- Recent changes to affected files (use terminal with `git log` on relevant files)
...
Create a GitHub issue using `terminal gh issue create` with the template below. Do NOT ask the user to review before creating - just create it and share the URL.
